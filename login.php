...
<body>  <header class="header_area">
    ...
    <div class='well' style='text-align:center; margin-top:40px; margin-bottom:30px;'>
        <form name='myform' method="post" action=<?php echo ($_GET['type']==0 ? "dashboard.php":"admindashboard.php");?> onsubmit='return validateform()'>
            <p>
                Username :
        ...
        <?php
        echo($_GET['type']==0?'<a href="signup.php">SignUp</a>':'');
        ?>
    </div>
